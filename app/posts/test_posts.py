...
add_data = """{
  "data": {
    ...
    {"body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "tittle": "test string", "creation_date": "2015-06-26", "published": "true", "author": "test string"}
         ,
...
update_data = """{
  "data": {
    "attributes":
        ...
        {"body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "tittle": "test string", "creation_date": "2015-06-26", "published": "false", "author": "test string"},
    "type": "posts"
  }
